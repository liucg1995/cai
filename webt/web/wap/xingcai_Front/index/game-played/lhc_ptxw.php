...
<div class="dGameStatus hklhc lotteryView_sxtw" action="tzlhcSelect" length="1">
		...
		<dd>
		<span id="RteSPBSOED" class="sGameStatusItem">0尾</span><span class="num" style="margin-left:12px;" data-id="RteLTTSD0"><?=$this->getLHCRte('RteLTTSD0',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input maxlength="5" id="RteLTTSD0" name="LTTSD" acno="0尾" type="text"></span>
		</dd>
		<dd>
		<span id="RteSPBSOES" class="sGameStatusItem">1尾</span><span class="num" style="margin-left:12px;" data-id="RteLTTSD1"><?=$this->getLHCRte('RteLTTSD1',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input maxlength="5" id="RteLTTSD1" name="LTTSD" acno="1尾" type="text"></span>
		</dd>
		</dl>
			<dl>
		<dt>
		...
		<dd>
		<span id="RteSPBSOEO" class="sGameStatusItem">2尾</span><span class="num" style="margin-left:12px;" data-id="RteLTTSD2"><?=$this->getLHCRte('RteLTTSD2',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input maxlength="5" id="RteLTTSD2" name="LTTSD" acno="2尾" type="text"></span>
		</dd>
		<dd>
		<span id="RteSPBSOEE" class="sGameStatusItem">3尾</span><span class="num" style="margin-left:12px;" data-id="RteLTTSD3"><?=$this->getLHCRte('RteLTTSD3',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input maxlength="5" id="RteLTTSD3" name="LTTSD" acno="3尾" type="text"></span>
		</dd>
			</dl>
			<dl>
		<dt>
		...
		<dd>
		<span id="RteSPTBSOED" class="sGameStatusItem">4尾</span><span class="num" style="margin-left:12px;" data-id="RteLTTSD4"><?=$this->getLHCRte('RteLTTSD4',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input maxlength="5" id="RteLTTSD4" name="LTTSD" acno="4尾" type="text"></span>
		</dd>
		<dd>
		<span id="RteSPTBSOES" class="sGameStatusItem">5尾</span><span class="num" style="margin-left:12px;" data-id="RteLTTSD5"><?=$this->getLHCRte('RteLTTSD5',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input maxlength="5" id="RteLTTSD5" name="LTTSD" acno="5尾" type="text"></span>
		</dd>
			</dl>
			<dl>
		<dt>
		...
		<dd>
		<span id="RteSPTBSOEO" class="sGameStatusItem">6尾</span><span class="num" style="margin-left:12px;" data-id="RteLTTSD6"><?=$this->getLHCRte('RteLTTSD6',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input maxlength="5" id="RteLTTSD6" name="LTTSD" acno="6尾" type="text"></span>
		</dd>
		<dd>
		<span id="RteSPTBSOEE" class="sGameStatusItem">7尾</span><span class="num" style="margin-left:12px;" data-id="RteLTTSD7"><?=$this->getLHCRte('RteLTTSD7',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input maxlength="5" id="RteLTTSD7" name="LTTSD" acno="7尾" type="text"></span>
		</dd>
			</dl>
			<dl>
		<dt>
		...
		<dd>
		<span id="RteSPSBSD" class="sGameStatusItem">8尾</span><span class="num" style="margin-left:-3px;" data-id="RteLTTSD8"><?=$this->getLHCRte('RteLTTSD8',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input maxlength="5" id="RteLTTSD8" name="LTTSD" acno="8尾" type="text"></span>
		</dd>
		<dd>
		<span id="RteSPSBSS" class="sGameStatusItem">9尾</span><span class="num" style="margin-left:-3px;" data-id="RteLTTSD9"><?=$this->getLHCRte('RteLTTSD9',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input maxlength="5" id="RteLTTSD9" name="LTTSD" acno="9尾" type="text"></span>
		</dd>
			</dl>	
