            ...
            <div class="reg-info" id="reg_form_1">
                <ul>
                    ...
                    <li>
                        ...
                        <div class="info-right"><input type="checkbox" name="reg_checkbox" checked="checked"/>我已看过并同意<a class="orange" target="_self" onClick="" width="1000" height="653" border="0">《金沙彩票网络服务协议》</a></div>
                    </li>
                    <li>
                        <div class="info-left">&nbsp;</div>
...
<div class="jc-footer">
    ...
    <div class="foot_box">
        <div class="about_box">
            <p>2009-2017©<span>金沙彩票 | </span> 客服邮箱：cai1688vip@gmail.com<!-- 客服QQ：201716002 | 流量统计 -->
            <br><span class="c-grey">郑重提示：彩票有风险，投注需谨慎！ 不向未满18周岁的青少年出售彩票</span></p>
            <ul class="foot_info">
