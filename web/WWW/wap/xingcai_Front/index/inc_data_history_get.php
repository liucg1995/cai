<?php
	...
	$arr=array('1','5','12','14','26','60','61','62','75','76');
	if(in_array($this->type,$arr)){
		...
		<td><div class='periodlist' style='<?=$this->iff($h2=='对子','color:#FF00FF;','')?>'><?=$h2?></div></td>
		<td><div class='periodlist' style='<?if($h3=='组六'){echo 'color:#009999;';}else if($h3=='组三'){echo 'color:#f60;';}else{echo 'color:#FF2626;';}?>'><?=$h3?></div></td>
		</tr> 
